...
const Data = () => {
  return (
    <div className='home__data'>
        <h1 className='home__title'>Bourassine Imen
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <h3 className='home__subtitle'>IA & Data Science Engineer</h3>
        
        <p className='home__description'>Dedicated to using Operations Research and Data Science for impactful solutions. </p>
